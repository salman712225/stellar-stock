...
def evaluate_position(
    ...
    if df_enriched is not None and not df_enriched.empty:
        ...
        if position_type.lower() in ["long", "call"]:
            ...
            # For options, target is either premium or underlying target.
            # Assuming limit_price is target underlying price or option break-even.
            # Let's map target boundary:
            target_boundary = limit_price if not is_option else strike + limit_price # estimation
